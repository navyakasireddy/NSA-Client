...
export class CachesDataService {
    ...
    constructor(private _http: Http, private _requestOptions: RequestOptions, private _logger: Logger, private storageService: StorageService) {
        ...
        this._serverURL = json.restBaseURL + json.caches;
    }
    getList() {
        this._logger.info('CachesService : getList');
    ...
    Delete(id: string) {
        this._logger.info('CachesService : delete');
        let headers = this.storageService.getHeaders();
    ...
    update(actionItem: any) {
        this._logger.info('CachesService : update');
        let headers = this.storageService.getHeaders();
        let body = {
            "plugin": {
    ...
    create(actionItem: any) {  
        this._logger.info('CachesService : create');      
        let headers = this.storageService.getHeaders();
